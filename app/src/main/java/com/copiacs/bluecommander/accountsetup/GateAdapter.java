...
public class GateAdapter extends RecyclerView.Adapter<GateAdapter.BuildingHolder>{
    @NonNull
    @Override
    public BuildingHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v=LayoutInflater.from(parent.getContext()).inflate(R.layout.item_gate,parent,false);
